...
<div class="highlight"><pre><span class="cp">&lt;?php</span>
    <span class="nv">$fields</span> <span class="o">=</span> <span class="k">array</span><span class="p">(</span>
        ...
        <span class="s1">'title'</span> <span class="o">=&gt;</span> <span class="nx">__</span><span class="p">(</span><span class="s1">'Textarea Option - HTML Validated Custom'</span><span class="p">,</span> <span class="s1">'firebrick-admin'</span><span class="p">),</span>
        <span class="s1">'subtitle'</span> <span class="o">=&gt;</span> <span class="nx">__</span><span class="p">(</span><span class="s1">'Custom HTML Allowed (wp_kses)'</span><span class="p">,</span> <span class="s1">'firebrick-admin'</span><span class="p">),</span>
        <span class="s1">'desc'</span> <span class="o">=&gt;</span> <span class="nx">__</span><span class="p">(</span><span class="s1">'This is the description field, again good for additional info.'</span><span class="p">,</span> <span class="s1">'firebrick-admin'</span><span class="p">),</span>
...
<pre>
    $fields = array(
        'id'=>'7',
        'type' => 'textarea',
        'title' => __('Textarea Option - HTML Validated Custom', 'firebrick-admin'),
        'subtitle' => __('Custom HTML Allowed (wp_kses)', 'firebrick-admin'),
        'desc' => __('This is the description field, again good for additional info.', 'firebrick-admin'),
...
class ReduxFramework_textarea extends ReduxFramework {
     ...
     * Example Documentation:
            $fields = array(
                'id'       => 'css_editor',
                'type'     => 'ace_editor',
                'title'    => __('CSS Code', 'firebrick-admin'),
                'subtitle' => __('Paste your CSS code here.', 'firebrick-admin'),
                'mode'     => 'css',
                'theme'    => 'monokai',
